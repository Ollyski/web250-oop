...
if (!isset($_GET['id'])) {
  redirect_to(url_for('/active-record/bicycles/index.php'));
}
$id = $_GET['id'];
...
if (is_post_request()) {
  ...
  if ($result === true) {
    ...
    redirect_to(url_for('/active-record/bicycles/show.php?id=' . $id));
  } else {
    // show errors
  }
} else {
...
<div id="content">
  ...
  <a class="back-link" href="<?php echo url_for('/active-record/bicycles/index.php'); ?>">&laquo; Back to List</a>
  ...
  <div class="bicycle edit">
    ...
    <form action="<?php echo url_for('/active-record/bicycles/edit.php?id=' . h(u($id))); ?>" method="post">
